from 
class OTPNotificationService(INotificaton):
        def send_otp_login_email(self,
        request, otp_token: str, recipient_id: int | str, recipient_full_name: str, recipient_email: str
    ) -> None:
        """
        ...
        otp_login_url = self. _construct_otp_login_url(request, recipient_id)
        website_url = self._construct_website_url(request)
    ...
    def _construct_otp_login_url(self, request: HttpRequest, user_id: int | str) -> str:
        """
    ...
    def _construct_website_url(self, request: HttpRequest) -> str:
        """
