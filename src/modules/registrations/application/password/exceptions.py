...
from apps.core.shared.base_exceptions import BusinessRuleValidationException
...
class PasswordMismatchError(BusinessRuleValidationException):
...
class IncorrectPasswordError(BusinessRuleValidationException):
...
class PasswordTooShortError(BusinessRuleValidationException):
...
class PasswordTooSimilarError(BusinessRuleValidationException):
...
class PasswordTooCommonError(BusinessRuleValidationException):
...
class PasswordEntirelyNumericError(BusinessRuleValidationException):
